---
title: Shell Startup Files Loading Order on Linux and MacOS
date: "2019-10-25T14:00:00.000Z"
excerpt: Settling this once and for all
tags:
  - linux
  - macOS
  - osx
...
via ssh or when logging in through a tty terminal (not sure why we still talk
about these things like they are around).
...
[_source_](https://shreevatsa.wordpress.com/2008/03/30/zshbash-startup-files-loading-order-bashrc-zshrc-etc/)
